...
*/
    ...
    //     WithdrawRewardAll();
    //     // User[msg.sender].availableToWithdraw+=rewardOfUser(msg.sender);
    //     uint256 size = Tokenid[msg.sender].length;
    //     for(uint256 i=0;i<size;i++){
    //     removePower(Tokenid[msg.sender][i]);
    //     if(rewardOfUser(msg.sender, Tokenid[msg.sender][i])>0)alreadyAwarded[Tokenid[msg.sender][i]]=true;
    //     uint256 _index=find(Tokenid[msg.sender][i]);
    //     require(Tokenid[msg.sender][_index] ==Tokenid[msg.sender][i] ,"NFT with this _tokenId not found");
    //     Breed.transferFrom(address(this),msg.sender,Tokenid[msg.sender][i]);
    //     delete Tokenid[msg.sender][_index];
    //     Tokenid[msg.sender][_index]=Tokenid[msg.sender][Tokenid[msg.sender].length-1];
    //     stakingTime[msg.sender][Tokenid[msg.sender][i]]=0;
    //     Tokenid[msg.sender].pop();
    ...
    //     publicNFTs -= size;
    //     User[msg.sender].myNFT -= size;
    //     totalStakedNft[msg.sender] > 0 ? totalStakedNft[msg.sender] -= size : totalStakedNft[msg.sender]=0;
    ...
    // function totalRewardOfUser(address Add) internal view returns(uint256) {
    //     uint256 RewardToken;

    //     for(uint256 i = 0 ; i < Tokenid[Add].length ; i++){
           
    //         if(Breed.check_type(Tokenid[Add][i]) == 1)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*50 ether;     
    //         }
    //         if(Breed.check_type(Tokenid[Add][i]) == 2)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*100 ether;     
    //         }
    //         if(Breed.check_type(Tokenid[Add][i]) == 3)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*250 ether;     
    //         }
    //         if(Breed.check_type(Tokenid[Add][i]) == 4)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*500 ether;     
    //         }
    //         if(Breed.check_type(Tokenid[Add][i]) == 5)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*1000 ether;     
    //         }
    //         if(Breed.check_type(Tokenid[Add][i]) == 6)
    //         {
    //          RewardToken += (((block.timestamp - (stakingTime[Add][Tokenid[Add][i]])).div(time)))*5000 ether;     
    //         }
    //     }
