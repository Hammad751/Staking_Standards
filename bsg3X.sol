...
contract BSG is Ownable{
    ...
    // uint256 private timeStep = 5 minutes;
    ...
    ///////////////////////////////////////////////////////////////////////////////
    mapping(address => uint256) public userrr;
    mapping(address => bool) public use;
    uint256 amt;
    uint256 pkg = 15;
    function GETTT() public {
        
        amt += 1;
        RewardInfo storage userRewards = rewardInfo[msg.sender];
        userRewards.totalWithdrawls = 10;
        uint256 withdrawable = amt.add(userRewards.totalWithdrawls);

        if(withdrawable >= pkg){
            require(!use[msg.sender], "limit reached: update pkg");
            withdrawable = pkg;
            use[msg.sender] = true;
        }
        userrr[msg.sender] = withdrawable;
    }

    function updatepkg() public{
        pkg = 20;
        use[msg.sender] = true;
    }
    ///////////////////////////////////////////////////////////////////////////////
    ...
    function withdraw() external {
        ...
        ////////////////////////////////////////////////////////////////////
        uint256 maxWithdraw = withdrawable.add(userRewards.totalWithdrawls);
        if(maxWithdraw >= total){
            withdrawable = total;
        }
        // else{
